...
public class DBStorageDebug extends StoreFunc {
  ...
  public DBStorageDebug(String driver, String jdbcURL, String insertQuery) {
    this(driver, jdbcURL, null, null, insertQuery, "100");
  }

  public DBStorageDebug(String driver, String jdbcURL, String user, String pass,
  ...
  public DBStorageDebug(String driver, String jdbcURL, String user, String pass,
    ...
    log.debug("DBStorageDebug(" + driver + "," + jdbcURL + "," + user + ",XXXX,"
        + insertQuery + ")");
    try {
      ...
      return new OutputCommitter() {
        ...
        public void abortTask(TaskAttemptContext context) throws IOException {
          try {
            ...
            Exception e = sqe.getNextException();
            // only getting one "next" exception for now to rule out a possible infinite loop issue
            if(e != null) {
              log.error("abort task", e);
            }
